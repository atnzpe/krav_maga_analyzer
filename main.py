...
class KravMagaApp:
    ...
    def on_report_saved(self, e: ft.FilePickerResultEvent):
        ...
        try:
            ...
            # CORREÇÃO: Passando a lista de landmarks, e não o objeto bruto.
            ...
            # O esqueleto do mestre é sempre desenhado por lado (azul/laranja) como referência.
